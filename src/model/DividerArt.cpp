...
constexpr unsigned kCap = DividerRoleCap;
constexpr unsigned kArm = DividerRoleArm;
constexpr unsigned kOrn = DividerRoleOrnament;
...
const DividerShapeInfo kDividerShapes[] = {
	{DividerShape::None, "none", "None", "", 0.0, 0.0, DividerStretch::Spread, kCap | kOrn},
	...
	{DividerShape::Spear, "spear", "Spearpoint", R"(<path d="M0 0.5 Q1 0 2 0 L2 1 Q1 1 0 0.5 Z" fill="#ffffff"/>)",
	 2.0, 3.0, DividerStretch::Spread, kCap},
	...
	{DividerShape::ScrollEnd, "scroll_end", "Scroll End",
	 ...
	 R"(</g>)",
	 1.8, 4.0, DividerStretch::Spread, kCap},
	...
	{DividerShape::DecoStep, "deco_step", "Deco Step",
	 ...
	 R"(</g>)",
	 1.0, 3.0, DividerStretch::Spread, kCap},
	...
	{DividerShape::Diamond, "diamond", "Diamond", R"(<path d="M1 0 L2 0.5 L1 1 L0 0.5 Z" fill="#ffffff"/>)", 2.0,
	 3.5, DividerStretch::Spread, kCap | kOrn},
	...
	{DividerShape::NestedDiamond, "nested_diamond", "Nested Diamond",
	 ...
	 2.6, 4.5, DividerStretch::Spread, kOrn},
	...
	{DividerShape::Sparkle, "sparkle", "Four-Point Star",
	 ...
	 1.3, 4.5, DividerStretch::Spread, kCap | kOrn},
	...
	{DividerShape::Heart, "heart", "Heart",
	 ...
	 1.1, 3.5, DividerStretch::Spread, kOrn},
	...
	{DividerShape::Scroll, "scroll", "Scroll",
	 ...
	 R"(</g>)",
	 2.6, 3.5, DividerStretch::Spread, kOrn},
	...
	{DividerShape::Filigree, "filigree", "Filigree",
	 ...
	 R"(</g>)",
	 3.0, 4.5, DividerStretch::Spread, kOrn},
	...
	{DividerShape::DecoStack, "deco_stack", "Deco Interlock",
	 ...
	 3.2, 4.5, DividerStretch::Spread, kOrn},
	 ...
	 */
	{DividerShape::Custom, "custom", "Custom SVG", "", 1.0, 4.0, DividerStretch::Spread, kCap | kArm | kOrn},
};
...
const QVector<DividerShape> &dividerShapesForRole(DividerRole role)
{
	...
	static const QVector<DividerShape> caps = build(DividerRoleCap);
	static const QVector<DividerShape> arms = build(DividerRoleArm);
	static const QVector<DividerShape> ornaments = build(DividerRoleOrnament);

	switch (role) {
	case DividerRoleArm:
		return arms;
	case DividerRoleOrnament:
		return ornaments;
	case DividerRoleCap:
		break;
	}
